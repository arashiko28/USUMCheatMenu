...
void    itemMenu(void) {
    ...
    new_spoiler("Items");
        ...
        new_entry_managed_note("All Clothes FEMALE", "Don't activate it if you are male. You will receive the clothes immediatly", allClothes, ALLCLOTHES, EXECUTE_ONCE);
...
void	allClothes(void) {
	...
	WRITEU32(0x000004F8 + offset, 0x00010301);
	WRITEU32(0x000005A8 + offset, 0x00000003);
	WRITEU32(0x00000264 + offset, 0x01010103);
	WRITEU32(0x000003B4 + offset, 0x01010103);
	WRITEU32(0x00000394 + offset, 0x01010301);
}
...
void	allClothesM(void) {
	...
	WRITEU32(0x00000304 + offset, 0x00010301); //hecho
	WRITEU32(0x00000584 + offset, 0x00000003); //hecho
	WRITEU32(0x000001D8 + offset, 0x01030101);
	WRITEU32(0x000004B0 + offset, 0x01010301);
}